...
let SeeredImposter = document.querySelector("[data-SeeRedImposter]");
let SeeblueImposter = document.querySelector("[data-SeeBlueImposter]");
let ShowredImposter = document.querySelector("[data-ShowRedImposter]");
let ShowblueImposter = document.querySelector("[data-ShowBlueImposter]");
let hoverIMG = document.querySelector("[data-hoverIMG]");
let info = document.querySelector("[data-info]");
let lazy = document.querySelector("[data-restart]");
let turn = 1;
let orderOfClick = 0;
let xPos = 8,
  yPos = 8;
...
var xKnight = [2, 2, -2, -2, 1, 1, -1, -1];
var yKnight = [1, -1, 1, -1, 2, -2, 2, -2];
var xKing = [1, 1, -1, -1, 1, 0, -1, 0];
var yKing = [1, -1, 1, -1, 0, -1, 0, 1];
var impostorpos = [
  [1, 100],
  [6, 100]
];
var impostorCanSayHi = [0, 0];
var impostorDied = [0, 0];
...
lazy.addEventListener("click", () => {
  lazy.innerHTML = "Lười lắm tự reload lại page điiii";
});
...
SeeredImposter.addEventListener("click", () => {
...
SeeblueImposter.addEventListener("click", () => {
...
ShowredImposter.addEventListener("click", () => {
  if (impostorDied[0] === 1) return;
...
ShowblueImposter.addEventListener("click", () => {
  if (impostorDied[1] === 1) return;
